...
implicit none
     ...
     module procedure log_lsm_error
          ...
          select case (error_code) ! Проверка кода ошибки
               ...
               case ('WA_a') ! Встречается в lsm_all

                    write(*,'(/, 5x, a, /, 5x, a, /)') 'log_lsm_error: ', 'Не удалось выделить память для временной&
                                                                         & размещаемой переменной a.'

                    stop

               case ('WA_b') ! Встречается в lsm_all

                    write(*,'(/, 5x, a, /, 5x, a, /)') 'log_lsm_error: ', 'Не удалось выделить память для временной&
                                                                         & размещаемой переменной b.'

                    stop

               case ('WA_err') ! Встречается в lsm_all

                    write(*,'(/, 5x, a, /, 5x, a, /)') 'log_lsm_error: ', 'Не удалось выделить память для временной&
                                                                         & размещаемой переменной err.'

                    stop

               case ('WD_a') ! Встречается в lsm_all
               ...
               case ('WD_b') ! Встречается в lsm_all
               ...
               case ('WD_err') ! Встречается в lsm_all
