submodule ( solve_bvp_shooting_m ) solve_bvp_shooting_LB2_and_RB3_loud_s
implicit none
     ...
     module procedure solve_bvp_shooting_LB2_and_RB3_loud
     ...
     end procedure solve_bvp_shooting_LB2_and_RB3_loud
     
end submodule solve_bvp_shooting_LB2_and_RB3_loud_s