submodule ( solve_bvp_shooting_m ) solve_bvp_shooting_LB2_and_RB2_loud_s
implicit none
     ...
     module procedure solve_bvp_shooting_LB2_and_RB2_loud
     ...
     end procedure solve_bvp_shooting_LB2_and_RB2_loud
     
end submodule solve_bvp_shooting_LB2_and_RB2_loud_s