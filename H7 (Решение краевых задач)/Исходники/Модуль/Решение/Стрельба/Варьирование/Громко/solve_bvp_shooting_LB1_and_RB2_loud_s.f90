submodule ( solve_bvp_shooting_m ) solve_bvp_shooting_LB1_and_RB2_loud_s
implicit none
     ...
     module procedure solve_bvp_shooting_LB1_and_RB2_loud
          ...
          write(*,'(5x, a, 3x, '//RF//')') 'Ориентировочное значение z(r):', z_r_target
     ...
     end procedure solve_bvp_shooting_LB1_and_RB2_loud
     
end submodule solve_bvp_shooting_LB1_and_RB2_loud_s