submodule ( solve_bvp_shooting_m ) solve_bvp_shooting_LB3_and_RB2_loud_s
implicit none
     ...
     module procedure solve_bvp_shooting_LB3_and_RB2_loud
          ...
          real(RP) :: z_r_target ! Ориентировочное значение y(r)

          ! Погрешности первого и второго z(r) по сравнению с ориентировочным y(r)
          real(RP) :: eps_1, eps_2
          ...
          write(*,'(5x, a, 8x, '//RF//')') 'Ориентировочное значение z(r):', z_r_target
     ...
     end procedure solve_bvp_shooting_LB3_and_RB2_loud
     
end submodule solve_bvp_shooting_LB3_and_RB2_loud_s