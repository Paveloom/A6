submodule ( solve_bvp_shooting_m ) solve_bvp_shooting_LB3_and_RB3_quiet_s
implicit none
     ...
     module procedure solve_bvp_shooting_LB3_and_RB3_quiet
     ...
     end procedure solve_bvp_shooting_LB3_and_RB3_quiet
     
end submodule solve_bvp_shooting_LB3_and_RB3_quiet_s