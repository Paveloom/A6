...
implicit none
     ...
     logical(1) :: q_print_convergence ! Выводить процесс схождения?
     ...
     ! Считывание начальных значений малых величин дельта-1 и дельта-2 (см. PDF задания)
     read(*,'(//)'); read(*,*) d1; read(*,*) d2

     ! Считывание ответа на вопрос о выводе процесса схождения
     read(*,'(/)'); read(*,*) q_print_convergence
     ...
     call gauss_quad_sp_init(n, a, b, t, w, c, eps, d1, d2, q_print_convergence, int)

     ! Вывод результата

     write(*,'(/, 4x, a, e26.16, /)') 'Результат:', int
